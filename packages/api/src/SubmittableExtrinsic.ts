...
import { AccountId, Address, ExtrinsicStatus, EventRecord, Hash, Header, Index, SignedBlock } from '@plugnet/types/interfaces';
...
import { createType, ClassOf, Method, Vec, ExtrinsicEra } from '@plugnet/types';
