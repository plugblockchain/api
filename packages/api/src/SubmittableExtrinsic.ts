...
import { ExtrinsicStatus, EventRecord, Hash, Index, SignedBlock } from '@plugnet/types/interfaces';
...
import { createType, AccountId, Address, getTypeRegistry, Header, Method, Vec, ExtrinsicEra } from '@plugnet/types';
