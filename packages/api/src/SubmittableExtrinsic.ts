...
import { AccountId, Address, ExtrinsicEra, ExtrinsicStatus, EventRecord, Hash, Header, Index, Method, SignedBlock } from '@plugnet/types/interfaces';
...
import { createType, ClassOf, Vec } from '@plugnet/types';
