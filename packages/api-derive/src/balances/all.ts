...
import { BalanceLock, VestingSchedule } from '@plugnet/types/interfaces/balances';
...
import { AccountId, AccountIndex, Address, ClassOf, Option, createType } from '@plugnet/types';
